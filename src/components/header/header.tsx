...
export const Header = () => {
    return <header className="h-[48px] mt-[45px]">
        <div className="container flex items-center justify-between flex-wrap gap-2.5 h-full">
            ...
            <div className="flex items-center gap-[50px] max-phone:hidden">
                    <div><span>userName</span></div>
                    <div><span>save</span></div>
            </div>
            <div className="max-phone:flex-1 relative h-full text-[#3E3232] w-full">
