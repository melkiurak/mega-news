...
export const  PostSlider = ({posts, titleBlock, postCardStyle, postItemStyle}:PostSliderProps) => {
    return <div>
        <div className="flex flex-col gap-5">
            ...
            <div className={`${postCardStyle} gap-6`}>
                {posts.map((post, index) => (
                    <div className={`${postItemStyle} gap-3 w-full shadow-[0_0_20px_rgba(0,0,0,0.1)] rounded-xl p-2.5`} key={index}>
                        <div className='w-full rounded-xl h-[186px] bg-center bg-cover bg-no-repeat flex-1/2' style={{backgroundImage: `url(${post?.imagePost})`}}></div>
